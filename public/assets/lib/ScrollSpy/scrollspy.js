        ...
        scrollspy: function (options) {
            ...
            var findElements = function (links) {
                ...
                for (var i = 0; i < links.length; i++) {
                    ...
                    // Get our hash
                    var hash = $(link).attr("data-overlay-content");
            ...
            var findLink = function (links, hash) {
                ...
                for (var i = 0; i < links.length; i++) {
                    ...
                    if (link.attr("data-overlay-content") === hash) {
            ...
            return this.each(function () {
                ...
                // Get our objects
                var links = $(element).find('div[data-overlay-content]');
                ...
                for (var i = 0; i < links.length; i++) {
                    ...
                    $(link).on("click", function (e) {
                        ...
                        // Get our target
                        var target = $(this).attr("data-overlay-content"),
                            $target = $(target);
